  ...
  return (
    <div className="form mt-10">
      <div class="max-w-md mx-auto">
        <p className='text-2xl mb-3 font-semibold'>Add New Book</p>
        ...
        <button onClick={handleClick} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Book</button>
      </div>
    </div>
  )
}
